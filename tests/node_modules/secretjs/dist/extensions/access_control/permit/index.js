...
//
const newPermit = (signer, owner, chainId, permitName, allowedTokens, permissions) => __awaiter(void 0, void 0, void 0, function* () {
    const { signature } = yield signer.signAmino(owner, (0, exports.newSignDoc)(chainId, permitName, allowedTokens, permissions));
    return {
        params: {
            chain_id: chainId,
